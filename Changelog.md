### v0.10.0-alpha.2 (2022-05-20)

Breaking Changes:

* `WasmEdge` updated. Please install the `WasmEdge 0.10.0-alpha.2` or newer version.
...
* Updated to the [WasmEdge 0.10.0-alpha.2](https://github.com/WasmEdge/WasmEdge/releases/tag/0.10.0-alpha.2).
